...
public class TrackServiceTest {
    ...
    public void testGetTrackDetailByIdNotFound() {
        ...
        StepVerifier.create(trackService.getTrackDetailById(id))
                .expectError(ResourceNotFoundException.class);
    }

    @Test
    public void testGetSeveralTrackDetails() {
        List<String> trackIds = List.of("K0l3eNFUCPGF3SbZ", "K0l3eNFUCPGF3SbZ", "xc", "xc", "ANfseNrP5DPz62aq");
        StepVerifier.create(trackService.getSeveralTrackDetails(trackIds))
